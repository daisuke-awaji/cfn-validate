...
def test_iam_policy_statement():
    ...
    for resource in cfn['Resources']:
        ...
        if cfn['Resources'][resource]['Type'] == '''AWS::IAM::ManagedPolicy''':
            if 'Properties' in cfn['Resources'][resource]:
                if 'PolicyDocument' in cfn['Resources'][resource]['Properties']:
                    print(cfn['Resources'][resource]['Properties'])
                    for rule in cfn['Resources'][resource]['Properties']['PolicyDocument']:
                        print(rule)
